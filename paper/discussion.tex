...
\item
  \textbf{Benchmark against newer sanitization baselines.} Compare NGSP
  directly against recent mechanisms such as CusText, CluSanT, and
  DYNTEXT, as well as attack-oriented evaluations like Tong et
  al.~(2025), rather than only against Safe Harbor-only or no-privacy
  baselines.
\item
